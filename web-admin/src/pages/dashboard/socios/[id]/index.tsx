            ...
            <Row>
              <Col xs={12} md={6}>
                <Form.Group className="mb-3" controlId="formBasicPassword">
                  ...
                  {errors.ci?.type === "required" && <span className="text-danger">{errors.ci?.message} </span>}
                </Form.Group>
              </Col>
              <Col xs={12} md={6}>
                <Form.Group className="mb-3" controlId="formBasicPassword">
                  ...
                  <span className="text-danger">{errors.nacionalidad?.message} </span>}
                </Form.Group>
              </Col>
            </Row>
            <Row>
              ...
              <Col xs={6} md={4}>
                <Form.Group className="mb-3" controlId="formBasicPassword">
                  ...
                  <span className="text-danger">{errors.emision?.message} </span>}
                </Form.Group>
              </Col>
              <Col xs={6} md={4}>
                <Form.Group className="mb-3" controlId="formBasicPassword">
                  ...
                  <span className="text-danger">{errors.vencimiento?.message} </span>}
                </Form.Group>
              </Col>
              <Col xs={12} md={4}>
                <Form.Group className="mb-3" controlId="formBasicPassword">
